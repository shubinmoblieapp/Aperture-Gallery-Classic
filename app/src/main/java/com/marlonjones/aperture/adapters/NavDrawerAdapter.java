...
public class NavDrawerAdapter extends RecyclerView.Adapter<NavDrawerAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mTextView = (TextView) v.findViewById(com.marlonjones.aperture.R.id.title);
        }
    }
    ...
    public NavDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(com.marlonjones.aperture.R.layout.list_item_drawer, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (entry.isAdd()) {
            holder.mTextView.setText(com.marlonjones.aperture.R.string.include_folder);
            ...
            holder.mTextView.setText(com.marlonjones.aperture.R.string.overview);
