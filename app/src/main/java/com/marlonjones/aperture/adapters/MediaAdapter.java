...
public class MediaAdapter extends HybridCursorAdapter<MediaAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            view = v;
            image = (ImpressionImageView) v.findViewById(com.marlonjones.aperture.R.id.image);
            imageProgress = v.findViewById(com.marlonjones.aperture.R.id.imageProgress);
            titleFrame = v.findViewById(com.marlonjones.aperture.R.id.titleFrame);
            title = (TextView) v.findViewById(com.marlonjones.aperture.R.id.title);
            subTitle = (TextView) v.findViewById(com.marlonjones.aperture.R.id.subTitle);
        }
    }
    ...
    public MediaAdapter(Context context, SortMode sort, ViewMode viewMode, Callback callback, boolean selectAlbumMode) {
        ...
        defaultImageBackground = Utils.resolveColor(context, com.marlonjones.aperture.R.attr.default_image_background);
        emptyImageBackground = Utils.resolveColor(context, com.marlonjones.aperture.R.attr.empty_image_background);
    }
    ...
    public MediaAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            v = LayoutInflater.from(mContext).inflate(mViewMode == ViewMode.GRID ?
                    com.marlonjones.aperture.R.layout.grid_item_entry_folder : com.marlonjones.aperture.R.layout.list_item_entry, parent, false);
        } else {
            v = LayoutInflater.from(mContext).inflate(mViewMode == ViewMode.GRID ?
                    com.marlonjones.aperture.R.layout.grid_item_entry : com.marlonjones.aperture.R.layout.list_item_entry, parent, false);
        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (entry.isAlbum()) {
            ...
            holder.image.setImageResource(com.marlonjones.aperture.R.drawable.ic_folder);

            if (mViewMode == ViewMode.LIST) {
                if (holder.subTitle != null) {
                    holder.subTitle.setVisibility(View.VISIBLE);
                    holder.subTitle.setText(com.marlonjones.aperture.R.string.folder);
                }
            } else if (holder.subTitle != null) {
