...
//Commented Out for this release
   ...
   // }
    ...
    private void invalidateAccountViews(View itemView, int currentIndex, int selectedIndex) {
        if (itemView == null) {
            ...
            TextView title = (TextView) itemView.findViewById(com.marlonjones.aperture.R.id.title);
            ImageView icon = (ImageView) itemView.findViewById(com.marlonjones.aperture.R.id.icon);

            Account acc = mAccounts.get(currentIndex);
            switch (acc.type()) {
                default:
                    icon.setImageResource(com.marlonjones.aperture.R.drawable.ic_folder);
                    break;
                case Account.TYPE_GOOGLE_DRIVE:
                    icon.setImageResource(com.marlonjones.aperture.R.drawable.ic_drive);
                    break;
                case Account.TYPE_DROPBOX:
                    icon.setImageResource(com.marlonjones.aperture.R.drawable.ic_dropbox);
                    break;
            }
    ...
    private View getAccountView(int index, int selectedIndex, ViewGroup container) {
        RelativeLayout view = (RelativeLayout) getActivity().getLayoutInflater().inflate(com.marlonjones.aperture.R.layout.list_item_account, container, false);
    ...
    private void showAccountAddDialog() {
        ...
        new MaterialDialog.Builder(getActivity())
                .title(com.marlonjones.aperture.R.string.add_account)
                .items(com.marlonjones.aperture.R.array.account_options)
                .itemsCallback(new MaterialDialog.ListCallback() {
                    @Override
                    public void onSelection(MaterialDialog materialDialog, View view, int i, CharSequence s) {
                        // Change when accounts access is made
    ...
    private void setupHeader(View view) {
        View addAccountFrame = ((ViewStub) view.findViewById(com.marlonjones.aperture.R.id.addAccountStub)).inflate();
        ((TextView) addAccountFrame.findViewById(com.marlonjones.aperture.R.id.title)).setTypeface(mAdapter.getRobotoMedium());
        ((ImageView) addAccountFrame.findViewById(com.marlonjones.aperture.R.id.icon)).getDrawable().mutate().setColorFilter(mRegularColor, PorterDuff.Mode.SRC_ATOP);

        mAccountsFrame = (LinearLayout) view.findViewById(com.marlonjones.aperture.R.id.accountsFrame);
        mAccountsFrame.findViewById(com.marlonjones.aperture.R.id.addAccountFrame).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
  ...
  //   }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.marlonjones.aperture.R.layout.fragment_navdrawer, container, false);
        RecyclerView mRecyclerView = (RecyclerView) view.findViewById(com.marlonjones.aperture.R.id.list);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        view.findViewById(com.marlonjones.aperture.R.id.headerFrame).setBackgroundColor(act.primaryColor());
    ...
    public void reloadAccounts() {
        ...
        View addAccountFrame = mAccountsFrame.findViewById(com.marlonjones.aperture.R.id.addAccountFrame);
    ...
    public void onEntrySelected(final int index, final NavDrawerAdapter.Entry entry, boolean longClick) {
        if (entry.isAdd()) {
            ...
            if (entry.isIncluded()) {
                new MaterialDialog.Builder(getActivity())
                        .content(Html.fromHtml(getString(com.marlonjones.aperture.R.string.confirm_folder_remove, entry.getPath())))
                ...
                new MaterialDialog.Builder(getActivity())
                        .content(Html.fromHtml(getString(com.marlonjones.aperture.R.string.confirm_exclude_album, entry.getPath())))
                        .positiveText(com.marlonjones.aperture.R.string.yes)
                        .negativeText(com.marlonjones.aperture.R.string.no)
                        .callback(new MaterialDialog.ButtonCallback() {
                            @Override
