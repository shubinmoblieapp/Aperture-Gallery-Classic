...
public class ViewerPageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view;
        if (isVideo) {
            view = inflater.inflate(com.marlonjones.aperture.R.layout.fragment_viewer_video, container, false);
            mVideo = (ImpressionVideoView) view.findViewById(com.marlonjones.aperture.R.id.video);
            ViewCompat.setTransitionName(mVideo, "view_" + mIndex);
        } else {
            view = inflater.inflate(com.marlonjones.aperture.R.layout.fragment_viewer, container, false);
            mPhoto = (ScaleListenerImageView) view.findViewById(com.marlonjones.aperture.R.id.photo);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (isVideo) {
            ...
            View playFrame = view.findViewById(com.marlonjones.aperture.R.id.playFrame);
            View seekFrame = view.findViewById(com.marlonjones.aperture.R.id.seekerFrame);
    ...
    private void loadImage() {
        if ((mEntry == null || mEntry.data() == null || mEntry.data().trim().isEmpty()) &&
            ...
            Utils.showErrorDialog(getActivity(), new Exception(getString(com.marlonjones.aperture.R.string.invalid_file_path_error)));
            attachPhotoView();
            return;
        }
