...
public class BreadCrumbLayout extends HorizontalScrollView implements View.OnClickListener {
    ...
    public static class Crumb implements Serializable {
        ...
        public String getTitle() {
            if (mPath.equals("/"))
                return mContext.getString(com.marlonjones.aperture.R.string.root);
            else if (mPath.equals(Environment.getExternalStorageDirectory().getAbsolutePath()))
                return mContext.getString(com.marlonjones.aperture.R.string.internal_storage);
    ...
    private void init() {
        setMinimumHeight((int) getResources().getDimension(com.marlonjones.aperture.R.dimen.breadcrumb_height));
    ...
    public void addCrumb(@NonNull Crumb crumb, boolean refreshLayout) {
        LinearLayout view = (LinearLayout) LayoutInflater.from(getContext()).inflate(com.marlonjones.aperture.R.layout.bread_crumb, this, false);
        view.setTag(mCrumbs.size());
        view.setOnClickListener(this);

        ImageView iv = (ImageView) view.getChildAt(1);
        Drawable arrow = ContextCompat.getDrawable(getContext(), com.marlonjones.aperture.R.drawable.ic_right_arrow);
    ...
    private TextView invalidateActivated(View view, boolean isActive, boolean noArrowIfAlone, boolean allowArrowVisible) {
        ...
        tv.setTextColor(ContextCompat.getColor(getContext(), isActive ? com.marlonjones.aperture.R.color.crumb_active : com.marlonjones.aperture.R.color.crumb_inactive));
