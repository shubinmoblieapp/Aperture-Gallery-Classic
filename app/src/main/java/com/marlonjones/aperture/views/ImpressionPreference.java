...
public class ImpressionPreference extends Preference {
    ...
    public ImpressionPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setLayoutResource(com.marlonjones.aperture.R.layout.preference_custom);
    }
    ...
    private void invalidateColor() {
        if (mView != null) {
            BorderCircleView circle = (BorderCircleView) mView.findViewById(com.marlonjones.aperture.R.id.circle);
            if (this.color != 0) {
