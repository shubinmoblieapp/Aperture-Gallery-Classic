...
public class EditorActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.marlonjones.aperture.R.layout.activity_editor);

        Toolbar mToolbar = (Toolbar) findViewById(com.marlonjones.aperture.R.id.toolbar);
        setSupportActionBar(mToolbar);
        mToolbar.setNavigationIcon(com.marlonjones.aperture.R.drawable.ic_action_discard);
        ...
        mEffectView = (GLSurfaceView) findViewById(com.marlonjones.aperture.R.id.effectsview);
    ...
    private void updateSeekLabel(float newValue) {
        TextView label = (TextView) findViewById(com.marlonjones.aperture.R.id.seekbarLabel);
    ...
    private void toggleAdjuster(boolean visible, int max, int defaultValue, AdjusterCallack callback) {
        findViewById(com.marlonjones.aperture.R.id.seekerFrame).setVisibility(visible ? View.VISIBLE : View.GONE);
        if (visible) {
            mAdjusterCallback = callback;
            SeekBar adjuster = (SeekBar) findViewById(com.marlonjones.aperture.R.id.seekbar);
            adjuster.setMax(max);
    ...
    private void hookupOptions() {
        findViewById(com.marlonjones.aperture.R.id.edit_autofix).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.isActivated()) {
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_filters).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu menu = new PopupMenu(EditorActivity.this, v);
                menu.inflate(com.marlonjones.aperture.R.menu.filters);
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_crop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO
            }
        });
        findViewById(com.marlonjones.aperture.R.id.edit_rotate).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IconizedMenu menu = new IconizedMenu(EditorActivity.this, v);
                menu.inflate(com.marlonjones.aperture.R.menu.rotation_popup);
                menu.setOnMenuItemClickListener(new IconizedMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == com.marlonjones.aperture.R.id.rotateLeft) {
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_flip).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IconizedMenu menu = new IconizedMenu(EditorActivity.this, v);
                menu.inflate(com.marlonjones.aperture.R.menu.flip_popup);
                menu.setOnMenuItemClickListener(new IconizedMenu.OnMenuItemClickListener() {
                    @Override
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == com.marlonjones.aperture.R.id.flipVertical) {
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_brightness).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.isActivated()) {
                    v.setActivated(false);
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_contrast).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.isActivated()) {
                    v.setActivated(false);
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_saturation).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.isActivated()) {
                    v.setActivated(false);
        ...
        findViewById(com.marlonjones.aperture.R.id.edit_sharpen).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.isActivated()) {
                    v.setActivated(false);
    ...
    private void displayBitmap(Bitmap bitmap) {
        ...
        findViewById(com.marlonjones.aperture.R.id.progress).setVisibility(View.GONE);
        findViewById(com.marlonjones.aperture.R.id.editControls).setVisibility(View.VISIBLE);
        mBitmap = bitmap;
        mEffectView.requestRender();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.marlonjones.aperture.R.menu.editor, menu);
